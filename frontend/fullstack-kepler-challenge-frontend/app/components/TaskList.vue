  ...
  <div>
    ...
    >
      ...
      >
        ...
        <div class="flex flex-shrink-0 gap-1 opacity-0 group-hover:opacity-100 transition-all focus-within:opacity-100">
          <button 
            @click="tasksStore.setEditingTask(task)"
            class="p-1 rounded-md text-gray-400 dark:text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors"
            title="Edit task"
          >
          ...
          <button 
            ...
            class="p-1 rounded-md text-gray-400 dark:text-gray-500 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
            title="Delete task"
          >
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
